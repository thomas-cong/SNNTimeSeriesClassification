...
python main.py --model lifstdpreadout --dataset twopattern --batch_size 1 --n_voters 10 --epochs 3 --stdp_passes 1 --reservoir_size 200 --reservoir_path "/home/tcong13/949Final/models/200_fixed_reservoir.pt"
